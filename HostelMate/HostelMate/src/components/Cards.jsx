...
const Cards = ({img}) => {
  ...
  return (
    <div className='rounded-xl'>
        ...
        <div
        key={index} 
        className="m-3 relative w-[93%] rounded-2xl md:rounded-lg overflow-hidden md:w-[31vw] md:h-45 h-30 md:mb-4 md:mt-4 flex flex-col items-cente border border-gray-200 shadow-sm md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
